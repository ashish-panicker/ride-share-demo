...
os.makedirs("pasenger-service/src/main/java/com/example/pasenger_service/controller", exist_ok=True)
controller_content = """package com.example.pasenger_service.controller;
...
"""
with open("pasenger-service/src/main/java/com/example/pasenger_service/controller/PassengerController.java", "w") as f:
